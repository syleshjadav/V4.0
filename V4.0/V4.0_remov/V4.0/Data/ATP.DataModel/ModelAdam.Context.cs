...
namespace ATP.DataModel
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<string> uspVerifyPinGetCustInfo_2ndTime(Nullable<int> dealerId, Nullable<System.Guid> personGuid, Nullable<System.Guid> vehicleGuid, Nullable<System.Guid> vehicleServciceGuid, Nullable<int> keyLockerId, Nullable<bool> isPickUpOrDrop)
        {
            var dealerIdParameter = dealerId.HasValue ?
                new ObjectParameter("DealerId", dealerId) :
                new ObjectParameter("DealerId", typeof(int));
            ...
            var vehicleServciceGuidParameter = vehicleServciceGuid.HasValue ?
                new ObjectParameter("VehicleServciceGuid", vehicleServciceGuid) :
                new ObjectParameter("VehicleServciceGuid", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("uspVerifyPinGetCustInfo_2ndTime", dealerIdParameter, personGuidParameter, vehicleGuidParameter, vehicleServciceGuidParameter, keyLockerIdParameter, isPickUpOrDropParameter);
        }
