        ...
        private void MapMyShopDataToObject(uspSelAllCompInspectionExportData_Result[] m)
        {
            if (m != null && m.Count() == 1)
            {
                ...
                CustomerInfo = new CustVehInfo
                {
                    ...
                    City = d.City,
                    CurrOdo = d.CurrOdo == null ? null : d.CurrOdo.ToString(),
                    ...
                    Plate = d.Plate,
                    Policy = d.Plate,
                    PrevOdo = d.PrevOdo == 0 ? null : d.PrevOdo.ToString(),
                    State = d.CustState,
                    ...
                    Brakes = new Brakes
                    {
                        ...
                        BrakeLRThickness = d.BrakeFrontRightSize,
                        BrakeRFThickness = d.BrakeFrontRightSize,
                        BrakeRRThickness = d.BrakeRearSize
                    },
                    Tires = new Tires
                    {
...
public class CustVehInfo
{
    ...
    // public string Emissoncost { get; set; }
